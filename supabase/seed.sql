...
VALUES
-- Pizza (Vegetarian)
('Margherita (Medium)', 'Classic Italian pizza with tomato sauce, mozzarella, and fresh basil.', 200, 'Pizza', '/images/menu/margherita.jpg', true, 0, true),
('Margherita (Large)', 'Classic Italian pizza with tomato sauce, mozzarella, and fresh basil.', 250, 'Pizza', '/images/menu/margherita.jpg', true, 0, true),
('Corn O Mania (Medium)', 'Sweet corn kernels paired with a rich layer of melted mozzarella cheese.', 220, 'Pizza', '/images/menu/corn-pizza.jpg', true, 0, true),
('Corn O Mania (Large)', 'Sweet corn kernels paired with a rich layer of melted mozzarella cheese.', 270, 'Pizza', '/images/menu/corn-pizza.jpg', true, 0, true),
('Full Call Veg (Medium)', 'A vibrant medley of bell peppers, onions, tomatoes, and mushrooms.', 260, 'Pizza', '/images/menu/veg-pizza.jpg', true, 0, true),
('Full Call Veg (Large)', 'A vibrant medley of bell peppers, onions, tomatoes, and mushrooms.', 320, 'Pizza', '/images/menu/veg-pizza.jpg', true, 0, true),
('Veg Calzone (Medium)', 'Golden-brown folded pizza crust stuffed with savory seasonal vegetables.', 280, 'Pizza', '/images/menu/calzone.jpg', true, 0, true),
('Veg Calzone (Large)', 'Golden-brown folded pizza crust stuffed with savory seasonal vegetables.', 360, 'Pizza', '/images/menu/calzone.jpg', true, 0, true),
('Hot Mexicana (Medium)', 'Spicy peppers, onions, and jalapeños for a zesty Mexican-inspired flavor.', 240, 'Pizza', '/images/menu/mexican-pizza.jpg', true, 0, true),
('Hot Mexicana (Large)', 'Spicy peppers, onions, and jalapeños for a zesty Mexican-inspired flavor.', 300, 'Pizza', '/images/menu/mexican-pizza.jpg', true, 0, true),
('Paneer Delight (Medium)', 'Creamy marinated paneer chunks topped with crisp onions and capsicum.', 260, 'Pizza', '/images/menu/paneer-pizza.jpg', true, 0, true),
('Paneer Delight (Large)', 'Creamy marinated paneer chunks topped with crisp onions and capsicum.', 320, 'Pizza', '/images/menu/paneer-pizza.jpg', true, 0, true),
('Puttanesca (Medium)', 'Gourmet pizza with rich pesto sauce, olives, and premium mozzarella.', 270, 'Pizza', '/images/menu/calzone.jpg', true, 0, true),
('Puttanesca (Large)', 'Gourmet pizza with rich pesto sauce, olives, and premium mozzarella.', 330, 'Pizza', '/images/menu/calzone.jpg', true, 0, true),
('Tandoori Paneer (Medium)', 'Spiced tandoori paneer with red onions and a hint of smoky flavor.', 270, 'Pizza', '/images/menu/paneer-pizza.jpg', true, 0, true),
('Tandoori Paneer (Large)', 'Spiced tandoori paneer with red onions and a hint of smoky flavor.', 330, 'Pizza', '/images/menu/paneer-pizza.jpg', true, 0, true),

-- Pizza (Non-Veg)
('Chicken Fungi (Medium)', 'Tender chicken and earthy mushrooms on a classic tomato base.', 250, 'Pizza', '/images/menu/margherita.jpg', true, 0, true),
('Chicken Fungi (Large)', 'Tender chicken and earthy mushrooms on a classic tomato base.', 300, 'Pizza', '/images/menu/margherita.jpg', true, 0, true),
('BBQ Chicken (Medium)', 'Smoky BBQ sauce drizzled over juicy chicken and crunchy onions.', 250, 'Pizza', '/images/menu/mexican-pizza.jpg', true, 0, true),
('BBQ Chicken (Large)', 'Smoky BBQ sauce drizzled over juicy chicken and crunchy onions.', 300, 'Pizza', '/images/menu/mexican-pizza.jpg', true, 0, true),
('Chicken Calzone (Medium)', 'A folded pizza delight filled with spicy chicken and melted cheese.', 300, 'Pizza', '/images/menu/calzone.jpg', true, 0, true),
('Chicken Calzone (Large)', 'A folded pizza delight filled with spicy chicken and melted cheese.', 400, 'Pizza', '/images/menu/calzone.jpg', true, 0, true),
('Hot Shot Chicken (Medium)', 'Extra spicy chicken chunks with jalapeños for a fiery kick.', 270, 'Pizza', '/images/menu/margherita.jpg', true, 0, true),
('Hot Shot Chicken (Large)', 'Extra spicy chicken chunks with jalapeños for a fiery kick.', 330, 'Pizza', '/images/menu/margherita.jpg', true, 0, true),
('Tandoori Chicken (Medium)', 'Tandoori marinated chicken with Indian spices and red onions.', 260, 'Pizza', '/images/menu/paneer-pizza.jpg', true, 0, true),
('Tandoori Chicken (Large)', 'Tandoori marinated chicken with Indian spices and red onions.', 320, 'Pizza', '/images/menu/paneer-pizza.jpg', true, 0, true),
('Chicken Mexicana (Medium)', 'Spiced chicken with corn and peppers on a Mexican-style base.', 250, 'Pizza', '/images/menu/mexican-pizza.jpg', true, 0, true),
('Chicken Mexicana (Large)', 'Spiced chicken with corn and peppers on a Mexican-style base.', 300, 'Pizza', '/images/menu/mexican-pizza.jpg', true, 0, true),
...
('Veg Pattie & Cheese Burger', 'Crispy veg patty with cheese and fresh veggies. Free fries included.', 120, 'Burgers & Wraps', '/images/menu/burger.jpg', true, 0, true),
('Peri Peri Paneer Cheese Burger', 'Spicy peri-peri paneer with cheese and veggies. Free fries included.', 150, 'Burgers & Wraps', '/images/menu/burger.jpg', true, 0, true),
('Crispy Paneer Cheese Burger', 'Breaded crispy paneer with cheese. Free fries included.', 170, 'Burgers & Wraps', '/images/menu/burger.jpg', true, 0, true),
('Chicken BBQ Burger', 'Grilled chicken with smoky BBQ sauce and cheese. Free fries included.', 180, 'Burgers & Wraps', '/images/menu/burger-alt.jpg', true, 0, true),
('Crispy Chicken Burger', 'Golden fried chicken breast with special mayo. Free fries included.', 200, 'Burgers & Wraps', '/images/menu/burger-alt.jpg', true, 0, true),
('Peri Peri Chicken Burger', 'Spicy peri-peri chicken with cheese. Free fries included.', 180, 'Burgers & Wraps', '/images/menu/burger-alt.jpg', true, 0, true),
('Chicken Pattie Burger', 'Juicy chicken patty with cheese and lettuce. Free fries included.', 150, 'Burgers & Wraps', '/images/menu/burger-alt.jpg', true, 0, true),
('Egg and Cheese Burger', 'Fluffy egg and melted cheese. Free fries included.', 140, 'Burgers & Wraps', '/images/menu/burger-alt.jpg', true, 0, true),

-- Sandwiches (Free Fries Included)
('Freestyle Sandwich', 'Customize your sandwich with a variety of fresh fillings. Free fries included.', 140, 'Sandwiches', '/images/menu/sandwich.jpg', true, 0, true),
('Grill Paneer Sandwich', 'Perfectly grilled paneer with spices. Free fries included.', 180, 'Sandwiches', '/images/menu/sandwich.jpg', true, 0, true),
('Corn & Cheese Sandwich', 'Sweet corn and gooey cheese between toasted bread. Free fries included.', 140, 'Sandwiches', '/images/menu/sandwich.jpg', true, 0, true),
('Chicken & Cheese Sandwich', 'Savory chicken and melted cheese. Free fries included.', 200, 'Sandwiches', '/images/menu/sandwich.jpg', true, 0, true),
('Egg & Cheese Sandwich', 'Wholesome egg and cheese sandwich. Free fries included.', 150, 'Sandwiches', '/images/menu/sandwich.jpg', true, 0, true),

-- Pasta (Add Chicken ₹50)
('Aglio e Olio', 'Classic pasta with garlic, olive oil, and chili flakes.', 300, 'Pasta & Salads', '/images/menu/pasta.jpg', true, 0, true),
('White Sauce Pasta', 'Rich and creamy bechamel sauce pasta.', 250, 'Pasta & Salads', '/images/menu/pasta.jpg', true, 0, true),
('Red Sauce Pasta', 'Tangy tomato-based Italian pasta.', 200, 'Pasta & Salads', '/images/menu/pasta.jpg', true, 0, true),
('Mix Sauce Pasta', 'The best of both worlds: red and white sauce combined.', 300, 'Pasta & Salads', '/images/menu/pasta.jpg', true, 0, true),
('Spaghetti Al Polo', 'Spaghetti served with savory chicken pieces.', 330, 'Pasta & Salads', '/images/menu/pasta.jpg', true, 0, true),
...
('Homemade Fries', 'Thick hand-cut artisanal potato fries.', 150, 'Sides & Snacks', '/images/menu/fries.jpg', true, 0, true),
...
('Homemade Chilli Fries', 'Spicy hand-cut fries with a fiery kick.', 250, 'Sides & Snacks', '/images/menu/fries.jpg', true, 0, true),
...
('Spicy Paneer Wrap', 'Marinated spicy paneer with fresh veggies.', 170, 'Burgers & Wraps', '/images/menu/wrap.jpg', true, 0, true),
