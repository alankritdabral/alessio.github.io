        ...
        <div className={styles.grid}>
          <div className={styles.info}>
            ...
            <p className={styles.description}>
              A hidden gem in Dehradun, offering exceptional artisanal Italian culinary experiences. We pride ourselves on our traditional thin-crust pizza and in-house handmade bread, creating unforgettable meals in a serene atmosphere.
            </p>
          </div>
